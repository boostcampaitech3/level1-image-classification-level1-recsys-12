...
def inference(data_dir, model_dir, output_dir, args):
    ...
    info['ans'] = preds
    info.to_csv(os.path.join(output_dir, '{}.csv'.format(args.name)), index=False)
...
if __name__ == '__main__':
    ...
    inference(data_dir, model_dir, output_dir, args) # output 파일명 --name인수로 변경가능 / model_dir로 저장된 모델 위치 설정
