...
def main(args):
    ...
    # -- dataset
    dataset = AgeBaseDataset(args.data_dir)
    num_classes = 10
        ...
        for epoch in range(args.epochs):
            ...
            for idx, batch in enumerate(train_loader):
                ...
                if (idx + 1) % args.log_interval == 0:
                    ...
                    print(
                        f"Epoch[{epoch + 1:3}/{args.epochs}]({idx + 1:>3}/{len(train_loader)}) || "
            ...
            with torch.no_grad():
                ...
                for val_batch in val_loader:
                    ...
                    loss_item = criterion(val_outputs, age)
                    acc_item = (age == val_preds).sum().item()
                    ...
                    val_label_list.extend(age.cpu().numpy())
                    val_origin_pred_list.extend(val_real_preds.cpu().nunpy())
    ...
    submission.to_csv(os.path.join(args.output_dir, 'submission_age_prediction.csv'), index=False)
