...
def main(args):
    ...
    # -- dataset
    dataset = MaskOnlyBaseDataset(args.data_dir)
    num_classes = 3
    ...
    submission.to_csv(os.path.join(args.output_dir, f'submission_mask_prediction_{args.model}_{args.version}.csv'), index=False)
